...
public class Farmacija {
    public static void main(String[] args) throws NumberFormatException, IOException {
        ...
        for(int i = 0; i<N; i++){
            ...
            String namena = p[1];
            Integer cena = Integer.parseInt(p[2]);
            table.insert(namena, new Lek(ime,namena,cena));
        ...
        String ime ="";
        if(curr!=null) {
            int min = curr.element.value.cena;
            ime = curr.element.value.ime;
            while(curr!=null)
            {
                if (curr.element.value.cena < min) {
                    min = curr.element.value.cena;
                    ime = curr.element.value.ime;
                }
                curr = curr.succ;
            }
...
Class Lek implements Comparable<Lek> {
    ...
    public Lek(String ime, String namena, int cena) {
        ...
        return ime.compareTo(anotherString);
        }
        @Override
